...
const GAMES = [
    ...
    { id: 2, name: 'Counter-Strike 2', image: 'placeholder.jpg', genre: 'Shooter', platform: ['PC'], type: 'Multiplayer', releaseDate: '2023', rating: 4.5, description: 'The long-running competitive shooter, rebuilt with refreshed maps and physics.' },
    { id: 3, name: 'DOOM Eternal', image: 'placeholder.jpg', genre: 'Shooter', platform: ['PC', 'PlayStation', 'Xbox'], type: 'Single-player', releaseDate: '2020', rating: 4.7, description: 'A fast, brutal single-player campaign built entirely around momentum and combat flow.' },
    { id: 4, name: 'Left 4 Dead 2', image: 'placeholder.jpg', genre: 'Shooter', platform: ['PC'], type: 'Co-op', releaseDate: '2009', rating: 4.6, description: 'Four survivors fight through zombie-infested campaigns that reward teamwork.' },
    { id: 5, name: 'Ghost of Tsushima', image: 'placeholder.jpg', genre: 'Action-Adventure', platform: ['PlayStation', 'PC'], type: 'Single-player', releaseDate: '2020', rating: 4.9, description: 'An open-world samurai epic built around exploration and cinematic combat.' },
    ...
    { id: 7, name: 'Batman: Arkham City', image: 'placeholder.jpg', genre: 'Action-Adventure', platform: ['PC', 'PlayStation', 'Xbox'], type: 'Single-player', releaseDate: '2011', rating: 4.7, description: 'Iconic Freeflow combat inside a dense, atmospheric open prison district.' },
    ...
    { id: 9, name: 'Persona 5 Royal', image: 'placeholder.jpg', genre: 'RPG', platform: ['PC', 'PlayStation', 'Xbox'], type: 'Single-player', releaseDate: '2020', rating: 4.9, description: 'A stylish turn-based RPG with a huge, character-driven story.' },
    { id: 10, name: 'Undertale', image: 'placeholder.jpg', genre: 'RPG', platform: ['PC'], type: 'Single-player', releaseDate: '2015', rating: 4.8, description: 'A short, endlessly clever RPG where every choice to fight or spare matters.' },
    { id: 11, name: 'Fallout 4', image: 'placeholder.jpg', genre: 'RPG', platform: ['PC', 'PlayStation', 'Xbox'], type: 'Single-player', releaseDate: '2015', rating: 4.3, description: 'A massive open world to explore, with deep settlement building on top.' },
    { id: 12, name: "Sid Meier's Civilization VI", image: 'placeholder.jpg', genre: 'Strategy', platform: ['PC'], type: 'Both', releaseDate: '2016', rating: 4.6, description: 'Build an empire from the Stone Age to the Information Age.' },
    { id: 13, name: 'XCOM 2', image: 'placeholder.jpg', genre: 'Strategy', platform: ['PC', 'PlayStation', 'Xbox'], type: 'Single-player', releaseDate: '2016', rating: 4.5, description: 'Punishing, tactical turn-based combat against an alien occupation.' },
    { id: 14, name: 'StarCraft II', image: 'placeholder.jpg', genre: 'Strategy', platform: ['PC'], type: 'Multiplayer', releaseDate: '2010', rating: 4.7, description: 'A genre-defining RTS with tight mechanics and a legendary esports scene.' },
    { id: 15, name: 'Project Zomboid', image: 'placeholder.jpg', genre: 'Survival', platform: ['PC'], type: 'Both', releaseDate: '2013', rating: 4.6, description: 'Deep survival and base-building against a relentless zombie apocalypse.' },
    { id: 16, name: 'Fire Emblem: Three Houses', image: 'placeholder.jpg', genre: 'Strategy', platform: ['PC'], type: 'Single-player', releaseDate: '2019', rating: 4.6, description: 'Tactical, turn-based battles woven into a deep academy-life sim.' },
    { id: 17, name: 'Pokemon White 2', image: 'placeholder.jpg', genre: 'RPG', platform: ['PC'], type: 'Both', releaseDate: '2012', rating: 4.5, description: 'A classic monster-collecting RPG with an expanded post-game region.' },
    { id: 18, name: 'Total War: Warhammer III', image: 'placeholder.jpg', genre: 'Strategy', platform: ['PC'], type: 'Both', releaseDate: '2022', rating: 4.4, description: 'Massive real-time battles layered on top of turn-based empire management.' },
    { id: 19, name: 'Age of Empires IV', image: 'placeholder.jpg', genre: 'Strategy', platform: ['PC'], type: 'Multiplayer', releaseDate: '2021', rating: 4.4, description: 'A modern take on the classic real-time strategy formula.' },
